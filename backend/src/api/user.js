...
class UserApi {
    ...
    async updateUser(req, res) {
        ...
        try {
            ...
            // Se o usuário não for admin, ele não pode alterar o papel para "admin"
    ...
    async deleteUser(req, res) {
        ...
        try {
            ...
            // Se o usuário não for admin, ele só pode deletar a si mesmo
    ...
    async login(req, res) {
        ...
        try {
            const { message, token } = await UserController.login(email, senha);
    ...
    async verifyEmailToken(req, res) {
        ...
        try {
            const result = await UserController.verificarEmailToken(emailToken);
